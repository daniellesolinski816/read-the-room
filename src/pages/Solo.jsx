...
Return your evaluation in this exact JSON format:
{
  ...
  "nonjudgment": <0-25>,
  "door_open": <0-25>,
  "reflection": "<2-3 sentences of specific, realistic reflection. VARY your opening every time — do NOT default to 'Your response' or 'This response'. Mix it up: sometimes start with what landed ('There's something real in...'), sometimes with what was missing ('What's absent here is...'), sometimes with what the other person likely heard ('To them, this probably read as...'), sometimes with a plain observation ('Naming the feeling directly would have changed the whole register here.'). Warm, direct, never preachy. If disengaging was valid, say exactly why it was smart in this case — not a generic validation.>",
  "alternative_response": "<One realistic alternative demonstrating higher empathy. VOICE RULES: real person, not a therapist, not HR, not a school counselor. ABSOLUTELY FORBIDDEN: 'I hear that you are feeling', 'It sounds like', 'I want to make sure I understand', 'I appreciate you sharing', 'That must be really hard', 'I can see why you feel that way', 'I understand that', 'Thank you for sharing'. VARY the structure each time: sometimes open with a question, sometimes a brief honest reaction before turning curious, sometimes a single quiet acknowledgment. For SOCIAL MEDIA scenarios: match the format — a DM can be warm and a bit longer; a public comment or reply should be brief, non-escalating, and not performative. If disengaging was appropriate, one sentence of dignified exit — no speeches.>"
}`;
